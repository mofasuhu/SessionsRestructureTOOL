...
\end{stem}    
\begin{distractors}
\distractor{los estudios de Gabriel García Márquez}
\distractor{la biografía de Gabriel García Márquez}
\distractor{las películas de Gabriel García Márquez}
\distractor{la familia de Gabriel García Márquez}
\end{distractors}              
\end{mcq}
\end{instance}
\end{question}