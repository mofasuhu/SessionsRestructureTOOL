...
Gabriel García Márquez es conocido $\nagwaTextBlank$.\par    
\end{stem}    
\begin{distractors}
\distractor{solo en Bogotá y en Colombia}
\distractor{solo en Latinoamérica y en España}
\distractor{en todo el mundo}
\distractor{solo en Colombia y en Latinoamérica}
\end{distractors}             
\end{mcq}
\end{instance}
\end{question}